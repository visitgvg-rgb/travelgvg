...
import type { Shopping, MultiLangString } from '../types';
...
const ShoppingDetailPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchShopping = async () => {
            ...
            try {
                ...
                const foundItem = data.find(s => s.id === slug);
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
                ...
                {hasWebsite && (
                    <a
                        ...
                        className='bg-blue-600 text-white hover:bg-blue-700 font-bold py-2 px-4 rounded-full transition-colors duration-300 text-sm shadow-md flex items-center gap-2'
                    >
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-6 whitespace-pre-line">{item.description[lang]}</p>
                         {renderConnectSection()}
                          <div className="flex flex-col gap-3 w-full">
                                {item.contact.phone && (
                                    <a href={`tel:${item.contact.phone}`} className='w-full flex items-center justify-center bg-blue-600 text-white hover:bg-blue-700 font-black py-3.5 px-6 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200'>
